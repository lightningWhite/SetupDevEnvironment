...
let g:colors_name = "lightningWhite"
...
hi SignColumn		ctermbg=none guifg=Black
...
hi Error			ctermfg=red ctermbg=none guifg=Red
hi Todo				ctermfg=yellow ctermbg=none guifg=Blue cterm=underline
hi SpellBad			ctermfg=red ctermbg=none guifg=Blue cterm=underline
